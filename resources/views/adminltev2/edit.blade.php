                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <select name="users[]" id="users" class="select2 form-control" multiple="multiple">
                                    @foreach($users as $user)
                                        <option value="{{ $user['id'] }}">{{ $user['name'] }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control " placeholder="" name="textarea" cols="50" rows="10" id="textarea"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
